...
export const MatchesList = () => {
  ...
  return (
    <Table variant="simple" size="sm" w={["200px", "300px"]} margin="0 auto" mt={["8px", "20px"]}>
      <Thead>
        <Tr>
          <Th>Home</Th>
          ...
          <Tr key={m.id}>
            <Td w={["70px", "150px"]}>
              <Flex dir="row" alignItems="center">
                <Box w={{ base: "14px", md: "30px" }} h={{ base: "14px", md: "30px" }} mr="8px">
                  <Image
                ...
                <Text display={{ base: "inline", md: "none" }}>{m.match.homeTeam.countryCode}</Text>
              </Flex>
            </Td>
            <Td>
              <Input
            ...
            <Td w="150px">
              <Flex dir="row" alignItems="center">
                ...
                <Text display={{ base: "inline", md: "none" }}>{m.match.awayTeam.countryCode}</Text>
              </Flex>
            </Td>
          </Tr>
        ))}
